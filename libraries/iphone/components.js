...
prx.types.slider = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		if(item.vertical) {
			...
			cR += '#'+_id+' .slider-button { background-color: '+getColor(item.sliderColor)+'; '+cssBorderRadius(item.sliderBorderRadius+'px')+' width: '+item.sliderSize+'px; height: '+item.sliderSize+'px; margin-bottom: -'+(item.sliderSize/2)+'px; margin-top: -'+(item.sliderSize/2)+'px;  }'
		} else {
